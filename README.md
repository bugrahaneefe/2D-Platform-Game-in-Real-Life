...
- Unity Game Engine: Used for developing the game environment and mechanics
- Arduino IDE: Utilized for programming microcontroller
- Communication: Serial communication (I2C) is used for data transmissions
